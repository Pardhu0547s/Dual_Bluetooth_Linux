...
/// macOS audio service using CoreAudio Aggregate Multi-Output devices.
/// Communicates with native Swift code via MethodChannel.
class MacOSAudioService extends AudioService {
  ...
  @override
  String get platformName => 'macOS (CoreAudio)';
  ...
  Future<List<AudioSink>> getAudioSinks() async {
    try {
      ...
      print('macOS getAudioSinks error: $e');
      return [];
    }
  }
  ...
  Future<bool> startDualStream({
    ...
    try {
      ...
      print('macOS startDualStream error: $e');
      return false;
    }
  }
  ...
  Future<void> stopDualStream() async {
    ...
    try {
      ...
      print('macOS stopDualStream error: $e');
    }
    _isStreaming = false;
  }
